...
public class GameFrame extends DefaultFrame {
     ...
     * <p>
     * <br>
     * Finally, adds all background-wise unchanged LetterBoxes letters to the static noPositionLetters variable, unless the character is contained in wrongPositionLetters.
     *
     * @param userWord
     */
    void colorChange(String userWord) {
        ...
        for (int j = 0; j < WORD_LENGTH; j++) {
            ...
            if (letterBoxes[j][(int) focusPoint.getY()].getBackground() == theme.noPositionBackground() && !usedWrongPositionChars.contains("" + userWord.charAt(j)) ) {
